...
(() => {
  "use strict";
  var webpackModules = {
    "webpack/container/entry/remote": (unusedWebpackModule, exports, webpackRequire) => {
      var moduleMap = {
        "./NewsList": () => {
          return Promise.all([webpackRequire.e("webpack_sharing_consume_default_react_react"), webpackRequire.e("src_NewsList_js")]).then(() => () => webpackRequire("./src/NewsList.js"));
        },
        "./Banner": () => {
          return Promise.all([webpackRequire.e("webpack_sharing_consume_default_react_react"), webpackRequire.e("src_Banner_js")]).then(() => () => webpackRequire("./src/Banner.js"));
        }
      };
      var get = (module, getScope) => {
        webpackRequire.R = getScope;
        getScope = webpackRequire.o(moduleMap, module) ? moduleMap[module]() : Promise.resolve().then(() => {
          throw new Error('Module "' + module + '" does not exist in container.');
        });
        webpackRequire.R = undefined;
        return getScope;
      };
      var init = (shareScope, initScope) => {
        if (!webpackRequire.S) return;
        var name = "default";
        var oldScope = webpackRequire.S[name];
  ...
  (() => {
    ...
    webpackRequire.I = (name, initScope) => {
      ...
      if (!webpackRequire.o(webpackRequire.S, name)) webpackRequire.S[name] = {};
      ...
      var initExternal = id => {
        ...
        try {
          ...
          if (!module) return;
          var initFn = module => module && module.init && module.init(webpackRequire.S[name], initScope);
      ...
      switch (name) {
        case "default":
          {
            register("react-dom", "18.2.0", () => Promise.all([webpackRequire.e("vendors-node_modules_react-dom_index_js"), webpackRequire.e("webpack_sharing_consume_default_react_react")]).then(() => () => webpackRequire("../node_modules/react-dom/index.js")));
            register("react", "18.2.0", () => webpackRequire.e("vendors-node_modules_react_index_js").then(() => () => webpackRequire("../node_modules/react/index.js")));
          }
          break;
      }
  ...
  (() => {
    ...
    var ensureExistence = (scopeName, key) => {
      ...
      if (!scope || !webpackRequire.o(scope, key)) throw new Error("Shared module " + key + " doesn't exist in shared scope " + scopeName);
      return scope;
    };
    ...
    var init = fn => function (scopeName, a, b, c) {
      ...
      if (promise && promise.then) return promise.then(fn.bind(fn, scopeName, webpackRequire.S[scopeName], a, b, c));
    ...
    var loadFallback = init((scopeName, scope, key, fallback) => {
      return scope && webpackRequire.o(scope, key) ? get(findVersion(scope, key)) : fallback();
    });
    ...
    var loadStrictVersionCheckFallback = init((scopeName, scope, key, version, fallback) => {
      var entry = scope && webpackRequire.o(scope, key) && findValidVersion(scope, key, version);
    ...
    var moduleToHandlerMapping = {
      "webpack/sharing/consume/default/react/react": () => loadSingletonVersionCheckFallback("default", "react", [1, 18, 2, 0], () => webpackRequire.e("vendors-node_modules_react_index_js").then(() => () => webpackRequire("../node_modules/react/index.js")))
    };
    var chunkMapping = {
  ...
  var webpackExports = webpackRequire("webpack/container/entry/remote");
  remote = webpackExports;
})();